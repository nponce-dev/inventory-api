...
from app.routers import products, sales, purchases, discounts, servicios, sheet, ventas
...
app.include_router(servicios.router, dependencies=[Depends(get_current_user)])
app.include_router(sheet.router, dependencies=[Depends(get_current_user)])
app.include_router(ventas.router, dependencies=[Depends(get_current_user)])
